                ...
                {result && (
                    <ResultContainer>
                        ...
                        <ResultItem>
                            ...
                            <div className="context-label">Original Context:</div>
                            <p>{result.original_context}</p>
                        ...
                        <ResultItem>
                            ...
                            <SentimentBox>
                                {result.sentiment_analysis && typeof result.sentiment_analysis === 'string' && (
                                    <>
                                        {Object.entries(JSON.parse(result.sentiment_analysis)).map(([key, value]) => {
